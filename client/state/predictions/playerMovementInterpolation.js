const playerMovementInterpolation = otherPlayers => {
  for (let id in otherPlayers) {
    ...
    if (player.target_x !== undefined) {
      ...
      let angle = player.taget_rotation
      let dir = (angle - player.sprite.body.rotation) / (Math.PI * 2)
      dir -= Math.Round(dir)
      dir *= Math.PI * 2
      player.sprite.body.rotation += dir * 0.30

      //Interpolate name movement
      ...
      //Interpolate speed text movement
